#!/usr/bin/env python3
"""
Session-Based Workflow Test Script
==================================

Tests the new persistent session management:
1. Create/Get persistent session
...
def create_session():
    """Step 1: Create or get persistent session"""
    global SESSION_ID
    
    print("\n" + "="*70)
    print("📌 Step 1: Creating/Getting Persistent Session")
    print("="*70)
...
def choose_mode():
    ...
    print("\n" + "="*70)
    print("📦 Step 2: Choose Get Containers Mode")
    print("="*70)
    print("")
...
def test_mode_find():
    ...
    print("\n" + "="*70)
    print("🔍 Mode 3: Get Until Container ID Found")
    print("="*70)
    print(f"📋 Using Session ID: {SESSION_ID}")
    print("")
...
def main():
    ...
    print("\n" + "="*70)
    print("🧪 Session-Based Workflow Test")
    print("="*70)
    print("")
    ...
    print("\n⏸️  Press Enter to create/get session...")
    input()
    ...
    if mode == '1':
        ...
        test_mode_find()
        time.sleep(2)
        # test_mode_all()  # Skip infinite scroll in batch mode
